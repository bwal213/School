...
public class Ben_Walker_HW2_1 {
	...
	/**
	 * Assigns cards from the deck to their hands.
	 * 
	 * @param deck The cards in a random order.
	 * @param n The number of hands to be dealt.
	 */
	...
	/**
	 * Prints the hands to the console
	 * 
	 * @param hands The array of cards.
	 */
